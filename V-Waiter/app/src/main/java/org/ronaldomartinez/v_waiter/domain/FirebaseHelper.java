package org.ronaldomartinez.v_waiter.domain;
...
public class FirebaseHelper {
    ...
    private final static String FIREBASE_URL = "https://ronaldochat.firebaseio.com";
    ...
    public Firebase getChatsReference(String receiver) {
        receiver="restaurante.servicio@res.com";
